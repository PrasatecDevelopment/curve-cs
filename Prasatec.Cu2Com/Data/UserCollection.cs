...
{
    public sealed class UserCollection : Raden.ICollection<User>
    {
        private const int DEFAULT_LIMIT = 25;
        public UserCollection()
            : this(new Raden.QueryBuilder<User>().Build())
        {

        }
        public UserCollection(Raden.IQuery Query)
        {
        ...
        public User[] Records { get; private set; }
