...
{
    public sealed class PermissionCollection : Raden.ICollection<Permission>
    {
        private const int DEFAULT_LIMIT = 25;
        public PermissionCollection()
            : this(new Raden.QueryBuilder<Permission>().Build())
        {

        }
        public PermissionCollection(Raden.IQuery Query)
        {
        ...
        public Permission[] Records { get; private set; }
