...
{
    public sealed class UserSecureCollection : Raden.ICollection<UserSecure>
    {
        private const int DEFAULT_LIMIT = 25;
        public UserSecureCollection()
            : this(new Raden.QueryBuilder<UserSecure>().Build())
        {

        }
        public UserSecureCollection(Raden.IQuery Query)
        {
        ...
        public UserSecure[] Records { get; private set; }
