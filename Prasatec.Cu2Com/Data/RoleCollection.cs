...
{
    public sealed class RoleCollection : Raden.ICollection<Role>
    {
        private const int DEFAULT_LIMIT = 25;
        public RoleCollection()
            : this(new Raden.QueryBuilder<Role>().Build())
        {

        }
        public RoleCollection(Raden.IQuery Query)
        {
        ...
        public Role[] Records { get; private set; }
