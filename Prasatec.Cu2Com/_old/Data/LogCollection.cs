...
{
    public sealed class LogCollection : Raden.ICollection<Log>
    {
        private const int DEFAULT_LIMIT = 25;
        public LogCollection()
            : this(new Raden.QueryBuilder<Log>().Build())
        {

        }
        public LogCollection(Raden.IQuery Query)
        {
        ...
        public Log[] Records { get; private set; }
